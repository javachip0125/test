...
public class Application1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    * */
    ...
    //실행하는 클래스에도 throws Exception 키워드 추가 필요
